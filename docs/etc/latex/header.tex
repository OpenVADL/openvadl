...
\input{authors.md}
\\
\PBS\raggedleft\large Release: & $projectbrief \\
\\
\PBS\raggedleft\large Branch/Tag: & $projectnumber \\
\\
\PBS\raggedleft\large Revision: & $projectlogo \\
\\
\PBS\raggedleft\large License: & CC-BY-4.0
\end{longtabu}
%\vspace*{1cm}
