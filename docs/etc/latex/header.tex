...
\begin{tabular}{@{}r@{\hspace{12pt}}l@{}}
  % Author row spans both columns and is centered
  \multicolumn{2}{c}{\textbf{Andreas Krall}\quad\texttt{andi@complang.tuwien.ac.at}}\\[1.2ex]

  \textbf{Release:}    & $projectbrief \\
  \textbf{Branch/Tag:} & $projectnumber \\
  \textbf{Revision:}   & $projectlogo \\
