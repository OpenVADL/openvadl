...
Lines 13 to 19 demonstrate the definition of the `application binary interface` (see Section \r{abi_section}), the
`assembly description` (see Section \r{assembly_description_section}), the `processor` specification (see Section
\r{processor_section}).
