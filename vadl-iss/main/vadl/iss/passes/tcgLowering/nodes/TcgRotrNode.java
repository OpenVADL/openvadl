 ...
 */
public class TcgRotrNode extends TcgBinaryOpNode {

  public TcgRotrNode(TcgVRefNode res, TcgVRefNode arg, TcgVRefNode shiftAmount) {
  ...
  @Override
  public Node copy() {
    return new TcgRotrNode(firstDest().copy(TcgVRefNode.class),
  ...
  public Node shallowCopy() {
    return new TcgRotrNode(firstDest(), arg1, arg2);
  }
}
