...
public record VariantKind(String value, String human, boolean isImmediate) implements Renderable {
   ...
   */
  public static VariantKind absolute(Instruction instruction, Format.FieldAccess fieldAccess) {
    return new VariantKind(
        "VK_SYMB_ABS_" + instruction.identifier.lower() + "_" + fieldAccess.identifier.simpleName(),
        "SYMB_ABS_" + instruction.identifier.lower() + "_" + fieldAccess.identifier.simpleName(),
        true);
  }
   ...
   */
  public static VariantKind relative(Instruction instruction, Format.FieldAccess fieldAccess) {
    return new VariantKind("VK_SYMB_PCREL_" + instruction.identifier.lower() + "_"
        + fieldAccess.identifier.simpleName(),
        "SYMB_PCREL_" + instruction.identifier.lower() + "_" + fieldAccess.identifier.simpleName(),
        true);
  }
