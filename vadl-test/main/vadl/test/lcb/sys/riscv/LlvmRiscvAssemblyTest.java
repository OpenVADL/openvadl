...
public class LlvmRiscvAssemblyTest extends AbstractLcbTest {
    ...
    void compileLlvm() throws IOException, DuplicatedPassKeyException {
        ...
        {
            var inputStream = new FileInputStream("../../open-vadl/vadl-test/main/resources/images/llvm_riscv/Dockerfile");
        ...
        {
            var inputStream = new FileInputStream("../../open-vadl/vadl-test/main/resources/llvm/riscv/c/ILP32_add.c");
