...
<<<<<<< HEAD
        ...
        def RV64IM_Itype_immS_decodeAsInt64
            ...
            , ImmLeaf<i64, [{ return RV64IM_Itype_immS_decode_predicate(Imm); }]>;
        
        
        class RV64IM_Btype_immS_decode<ValueType ty> : Operand<ty>
        {
          let EncoderMethod = "RV64IM_Btype_immS_decode_encode";
          let DecoderMethod = "RV64IM_Btype_immS_decode_decode";
        }
        
        def RV64IM_Btype_immS_decodeAsInt64
            : RV64IM_Btype_immS_decode<i64>
            , ImmLeaf<i64, [{ return RV64IM_Btype_immS_decode_predicate(Imm); }]>;
        
        
        class RV64IM_Stype_immS_decode<ValueType ty> : Operand<ty>
        {
          let EncoderMethod = "RV64IM_Stype_immS_decode_encode";
          let DecoderMethod = "RV64IM_Stype_immS_decode_decode";
        }
        
        def RV64IM_Stype_immS_decodeAsInt64
            : RV64IM_Stype_immS_decode<i64>
            , ImmLeaf<i64, [{ return RV64IM_Stype_immS_decode_predicate(Imm); }]>;
