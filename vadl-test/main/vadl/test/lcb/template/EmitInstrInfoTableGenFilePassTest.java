...
public class EmitInstrInfoTableGenFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        def : Pat<(u8 (sextloadi8 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u8 (zextload8 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u64 (load (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u16 (sextloadi16 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u16 (zextload16 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u32 (sextloadi32 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
        ...
        def : Pat<(u32 (zextload32 (add X:$rs1, RV3264I_Itype_immS_decodeAsInt64:$immS)))
