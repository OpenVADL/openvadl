...
public class EmitTargetElfRelocsDefFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        ELF_RELOC(R_RV64IM_lo12_Btype_imm, 6)
        ELF_RELOC(R_RV64IM_lo12_Jtype_imm, 7)
        ELF_RELOC(R_RV64IM_lo12_Ftype_sft, 8)
        ELF_RELOC(R_RV64IM_hi20_Itype_imm, 9)
        ELF_RELOC(R_RV64IM_hi20_Utype_imm, 10)
        ELF_RELOC(R_RV64IM_hi20_Stype_imm, 11)
        ELF_RELOC(R_RV64IM_hi20_Btype_imm, 12)
        ELF_RELOC(R_RV64IM_hi20_Jtype_imm, 13)
        ELF_RELOC(R_RV64IM_hi20_Ftype_sft, 14)
