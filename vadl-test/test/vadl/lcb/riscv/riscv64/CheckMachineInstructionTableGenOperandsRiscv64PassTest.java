...
public class CheckMachineInstructionTableGenOperandsRiscv64PassTest extends AbstractLcbTest {
  ...
  static {
    ...
    inputOperands.add(new Entry("ADDI", List.of("X:$rs1", "RV3264Base_ADDI_immSAsInt64:$immS")));
    inputOperands.add(new Entry("AND", List.of("X:$rs1", "X:$rs2")));
    inputOperands.add(new Entry("ANDI", List.of("X:$rs1", "RV3264Base_ANDI_immSAsInt64:$immS")));
    inputOperands.add(
        new Entry("BEQ", List.of("X:$rs1", "X:$rs2", "RV3264Base_BEQ_immSAsLabel:$immS")));
    inputOperands.add(
        new Entry("BGE", List.of("X:$rs1", "X:$rs2", "RV3264Base_BGE_immSAsLabel:$immS")));
    inputOperands.add(
        new Entry("BGEU", List.of("X:$rs1", "X:$rs2", "RV3264Base_BGEU_immSAsLabel:$immS")));
    inputOperands.add(
        new Entry("BLT", List.of("X:$rs1", "X:$rs2", "RV3264Base_BLT_immSAsLabel:$immS")));
    inputOperands.add(
    ...
    inputOperands.add(new Entry("LBU", List.of("X:$rs1", "RV3264Base_LBU_immSAsInt64:$immS")));
    inputOperands.add(new Entry("LH", List.of("X:$rs1", "RV3264Base_LH_immSAsInt64:$immS")));
    inputOperands.add(new Entry("LHU", List.of("X:$rs1", "RV3264Base_LHU_immSAsInt64:$immS")));
    inputOperands.add(new Entry("LW", List.of("X:$rs1", "RV3264Base_LW_immSAsInt64:$immS")));
    inputOperands.add(new Entry("LWU", List.of("X:$rs1", "RV3264Base_LWU_immSAsInt64:$immS")));
    inputOperands.add(new Entry("LUI", List.of("RV3264Base_LUI_immUpAsInt64:$immUp")));
    ...
    inputOperands.add(
        new Entry("SB", List.of("X:$rs1", "X:$rs2", "RV3264Base_SB_immSAsInt64:$immS")));
    inputOperands.add(
        new Entry("SD", List.of("X:$rs1", "X:$rs2", "RV3264Base_SD_immSAsInt64:$immS")));
    inputOperands.add(
