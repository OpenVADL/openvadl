...
/**
 * Registers VDT-specific HTML dump extensions.
 */
public class VdtHtmlDumpExtensionProvider implements HtmlDumpExtensionProvider {
  ...
  @Override
  public void addEntitySuppliers(List<DumpEntitySupplier<?>> suppliers) {
