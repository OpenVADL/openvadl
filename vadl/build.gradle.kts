...
fun genCheckstyleMdReport(xmlReport: SingleFileReport) {
    ...
    mdReport.append(
        "<summary>&nbsp;$statusIcon <b>${reportFile.nameWithoutExtension}</b>: Checkstyle found <b>${errors.length}</b> violations</summary>\n\n",
    )
    mdReport.append("```\n")
