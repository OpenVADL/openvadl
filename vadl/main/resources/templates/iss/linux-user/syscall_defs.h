...
#define target_id abi_uint
    ...
    [# th:if="${gen_arch_upper == 'RV64UME'}"] || defined(TARGET_RV64UME) [/] \
...
struct target_stat64  {
    ...
    || defined(TARGET_RISCV)  \
    [# th:if="${gen_arch_upper == 'RV64UME'}"] || defined(TARGET_RV64UME) [/] \
    || defined(TARGET_HEXAGON) || defined(TARGET_LOONGARCH)
...
#if !defined(TARGET_RISCV64) [# th:if="${gen_arch_upper == 'RV64UME'}"] && !defined(TARGET_RV64UME) [/]
#define TARGET_HAS_STRUCT_STAT64
struct target_stat64 {
    abi_ullong st_dev;
    abi_ullong st_ino;
