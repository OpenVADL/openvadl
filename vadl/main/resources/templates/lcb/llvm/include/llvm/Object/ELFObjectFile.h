...
namespace llvm
{
  ...
  namespace object
  {
    ...
    template <class ELFT>
    class ELFObjectFile : public ELFObjectFileBase
    {
    ...
    template <class ELFT>
    Error ELFObjectFile<ELFT>::initContent()
    {
      auto SectionsOrErr = EF.sections();
      if (!SectionsOrErr)
        return SectionsOrErr.takeError();
    ...
    template <class ELFT>
    uint16_t ELFObjectFile<ELFT>::getEType() const
    {
    ...
    StringRef ELFObjectFile<ELFT>::getFileFormatName() const
    {
      ...
      case ELF::ELFCLASS32:
        ...
        case ELF::EM_XTENSA:
          return "elf32-xtensa";
        case ELF::EM_[(${namespace})]:
          return "ELF32-[(${namespace})]";
        default:
    ...
    template <class ELFT>
    Triple::ArchType ELFObjectFile<ELFT>::getArch() const
    {
    ...
    template <class ELFT>
    bool ELFObjectFile<ELFT>::isRelocatableObject() const
    {
