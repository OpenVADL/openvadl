...
namespace llvm
{
    ...
    public:
        [(${namespace})]Subtarget(const Triple &TargetTriple, StringRef Cpu, StringRef TuneCPU, StringRef FeatureString, const TargetMachine &TM, const TargetOptions &Options, CodeModel::Model CodeModel, CodeGenOptLevel OptLevel);
