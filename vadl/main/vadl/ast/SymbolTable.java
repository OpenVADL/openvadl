...
class SymbolTable {
  ...
  static class SymbolResolver extends RecursiveAstVisitor {
    ...
    public Void visit(AsmGrammarElementDefinition definition) {
      ...
      // Only the attribute needs special treatment here, and if it is set none of the other fields
      // are set (this is basically an enum).
      if (definition.attribute != null) {
        ...
        // All other options just need the default treatment
        definition.children().forEach(this::travel);
      }
