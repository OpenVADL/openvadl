...
/**
 * Wraps decoding functions into {@link GcbCppFunctionForFieldAccess}.
 */
public class CreateGcbFieldAccessCppFunctionFromDecodeFunctionPass extends Pass {

  public CreateGcbFieldAccessCppFunctionFromDecodeFunctionPass(GcbConfiguration gcbConfiguration) {
    super(gcbConfiguration);
  }

  @Override
  public PassName getName() {
    return new PassName("CreateGcbFieldAccessCppFunctionFromDecodeFunctionPass");
  }
