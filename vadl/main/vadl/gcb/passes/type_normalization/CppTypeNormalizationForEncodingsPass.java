 ...
 * This pass inserts bit mask to ensure that the code generation works for encodings.
 */
public class CppTypeNormalizationForEncodingsPass extends Pass {
  ...
  public Object execute(Map<PassKey, Object> passResults, Specification viam)
    ...
    viam.isas()
        ...
        .forEach(fieldAccess -> {
          ...
          typeNormalizer.makeTypesCppConform(fieldAccess.encoding());
        });
