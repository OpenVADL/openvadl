...
public class GeneralCompilerRegister extends CompilerRegister {
  ...
  public GeneralCompilerRegister(ArtificialResource artificialResource,
                                 ...
                                 List<String> altNames,
                                 int dwarfNumber) {
    super(generateName(artificialResource), asmName, altNames, dwarfNumber, address, false);
  }
  ...
  public GeneralCompilerRegister(ArtificialResource artificialResource,
                                 ...
                                 List<String> altNames,
                                 int dwarfNumber) {
    super(generateName(artificialResource), asmName, altNames, dwarfNumber, 0, false);
  }
