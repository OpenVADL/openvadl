...
/**
 * Represents a helper call.
 *
 * <p>Not really a TCG operation, but a call to a helper function that modifies the
 * {@code IsJmpState}. This node does <strong>not</strong> replace an actual helper call,
 * it just sets some flags needed during TCG translation time to decide how to exit/chain
 * translation blocks.
 */
public class TcgIsJmpHelperCall extends TcgNode {

  @Override
  public String cCode(Function<Node, String> nodeToCCode) {
    return "is_jmp_helper_call(&s);";
  }
  ...
  @Override
  public Node copy() {
    return new TcgIsJmpStateProlog();
  }
