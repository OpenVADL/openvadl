...
public class LlvmLoweringPass extends Pass {
   ...
   */
  public static IdentityHashMap<Instruction, MachineInstructionLabel> flipIsaMatchingMachineInstructions(
   ...
   */
  public static IdentityHashMap<PseudoInstruction, PseudoInstructionLabel> flipIsaMatchingPseudoInstructions(
