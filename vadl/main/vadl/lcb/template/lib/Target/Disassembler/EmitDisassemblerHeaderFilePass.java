...
public class EmitDisassemblerHeaderFilePass extends LcbTemplateRenderingPass {
  ...
  public EmitDisassemblerHeaderFilePass(LcbConfiguration lcbConfiguration) throws IOException {
  ...
  protected String getOutputPath() {
    ...
    return "llvm/lib/Target/" + processorName + "/Disassembler/" + processorName
        + "Disassembler.h";
  }
