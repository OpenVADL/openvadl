...
public sealed interface PointedItem {
  ...
  record Repetition(PointedItem expr, BigInteger from, BigInteger to) implements PointedItem {
  }

  record Permutation(List<PointedItem> elements) implements PointedItem {
  }
