...
/**
 * This annotation might be set on {@link Processor} definitions to mark it
 ...
 */
public class EnableHtifAnno extends Annotation<Processor> {

  @Override
  public Class<Processor> parentDefinitionClass() {
