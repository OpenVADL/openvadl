...
/**
 * Simplification rule when multiplication with one then return the first operand of
 * the multiplication.
 */
public class MultiplicationWithOneSimplificationRule implements AlgebraicSimplificationRule {
  @Override
