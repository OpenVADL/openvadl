...
; CHECK-LABEL: # %bb.0:
; CHECK-NEXT: SLLI a1,a1,0x7
; CHECK-NEXT: SRLI a2,a0,0x19
...
; CHECK-NEXT: SLLI a2,a1,0x18
; CHECK-NEXT: OR a0,a0,a2
; CHECK-NEXT: SRLI a1,a1,0x8
; CHECK-NEXT: RET
  %1 = lshr i64 %a, 8
  ret i64 %1
}
...
; CHECK-LABEL: # %bb.0:
; CHECK-NEXT: SRLI a0,a0,0x9
; CHECK-NEXT: SLLI a2,a1,0x17
; CHECK-NEXT: OR a0,a0,a2
; CHECK-NEXT: SRAI a1,a1,0x9
; CHECK-NEXT: RET
  %1 = ashr i64 %a, 9
  ret i64 %1
}
...
; CHECK-LABEL: # %bb.0:
; CHECK-NEXT: SRAI a2,a0,0x9
; CHECK-NEXT: SRAI a1,a0,0x1f
; CHECK-NEXT: ADDI a0,a2,0
; CHECK-NEXT: RET
  %1 = shl i64 %a, 32
  %2 = ashr i64 %1, 41
