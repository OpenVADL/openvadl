...
kper@merlin:~/dipl/temp/vadl/open-vadl/output/lcb/llvm-final/build/bin$ ^C
kper@merlin:~/dipl/temp/vadl/open-vadl/output/lcb/llvm-final/build/bin$ cat test.ll
; RUN: /src/llvm-final/build/bin/llc -mtriple=rv32im -O3 -verify-machineinstrs < $INPUT | /src/llvm-final/build/bin/FileCheck $INPUT
