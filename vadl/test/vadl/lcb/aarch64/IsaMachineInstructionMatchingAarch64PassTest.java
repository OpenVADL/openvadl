  ...
  private static Stream<Arguments> getExpectedMatchings() {
    return Stream.of(
        ...
        Arguments.of(List.of("B_LE"), MachineInstructionLabel.BSLEQ_BY_STATUS_REGISTER,
            Optional.empty()),
        Arguments.of(List.of("B_CS"), MachineInstructionLabel.BUGEQ_BY_STATUS_REGISTER,
            Optional.empty()),
        Arguments.of(List.of("B_HI"), MachineInstructionLabel.BUGTH_BY_STATUS_REGISTER,
            Optional.empty()),
        Arguments.of(List.of("B_CC"), MachineInstructionLabel.BULTH_BY_STATUS_REGISTER,
            Optional.empty()),
        Arguments.of(List.of("B_LS"), MachineInstructionLabel.BULEQ_BY_STATUS_REGISTER,
            Optional.empty()),
