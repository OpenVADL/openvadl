  ...
  private static Stream<Arguments> getExpectedMatchings() {
    return Stream.of(
        ...
        Arguments.of(List.of("B_LE"), MachineInstructionLabel.BSLEQ_BY_STATUS_REGISTER,
            Optional.empty()),
        Arguments.of(List.of("B_CS"), MachineInstructionLabel.B_CS,
            Optional.empty()),
        Arguments.of(List.of("B_CC"), MachineInstructionLabel.B_CC,
            Optional.empty()),
        Arguments.of(List.of("B_VS"), MachineInstructionLabel.B_VS,
            Optional.empty()),
        Arguments.of(List.of("B_VC"), MachineInstructionLabel.B_VC,
            Optional.empty()),
        Arguments.of(List.of("B_MI"), MachineInstructionLabel.B_NS,
            Optional.empty()),
        Arguments.of(List.of("B_PL"), MachineInstructionLabel.B_NC,
            Optional.empty()),
        ...
        Arguments.of(List.of("SUBWS", "SUBWSSXTX", "SUBWSUXTX"),
            ...
            Optional.empty()),
        Arguments.of(List.of("CSELMIX"),
            MachineInstructionLabel.CSEL_NS_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELPLX"),
            MachineInstructionLabel.CSEL_NC_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELVSX"),
            MachineInstructionLabel.CSEL_VS_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELVCX"),
            MachineInstructionLabel.CSEL_VC_I64,
            Optional.empty()),
        ...
        Arguments.of(List.of("CSELNEX"),
            ...
            Optional.empty()),
        Arguments.of(List.of("CSELLTX"),
            MachineInstructionLabel.CSEL_SLTH_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELCCX"),
            MachineInstructionLabel.CSEL_CC_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELLEX"),
            MachineInstructionLabel.CSEL_SLEQ_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELGEX"),
            MachineInstructionLabel.CSEL_SGEQ_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELCSX"),
            MachineInstructionLabel.CSEL_CS_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELCCX"),
            MachineInstructionLabel.CSEL_CC_I64,
            Optional.empty()),
        Arguments.of(List.of("CSELGTX"),
