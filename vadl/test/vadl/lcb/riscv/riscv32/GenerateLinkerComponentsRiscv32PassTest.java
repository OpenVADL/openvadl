...
public class GenerateLinkerComponentsRiscv32PassTest extends AbstractLcbTest {
  ...
  private static Stream<Modifier> expectedModifiers() {
    ...
    return Stream.of(
        ...
        new Modifier("MO_RV3264I_got_pcrel_hi", REL, Optional.of(RelocationFunctionLabel.UNKNOWN)),
  ...
  private static Stream<VariantKind> expectedVariantKinds() {
    return Stream.of(
        ...
        new VariantKind("VK_GOT_RV3264I_got_pcrel_hi", "got_pcrel_hi", false),
  ...
  private static Stream<String> expectedFixupIds() {
    return Stream.of(
        ...
        "fixup_got_pcrel_hi_RV3264I_Itype_GLOBAL_OFFSET_TABLE_imm",
        "fixup_got_pcrel_hi_RV3264I_Utype_GLOBAL_OFFSET_TABLE_imm",
        "fixup_got_pcrel_hi_RV3264I_Stype_GLOBAL_OFFSET_TABLE_imm",
        "fixup_got_pcrel_hi_RV3264I_Btype_GLOBAL_OFFSET_TABLE_imm",
        "fixup_got_pcrel_hi_RV3264I_Jtype_GLOBAL_OFFSET_TABLE_imm",
        "fixup_got_pcrel_hi_RV3264I_Ftype_GLOBAL_OFFSET_TABLE_sft",
  ...
  private static Stream<String> expectedUserSpecifiedRelocationIds() {
    return Stream.of(
        ...
        "R_RV3264I_got_pcrel_hi_Itype_imm",
        "R_RV3264I_got_pcrel_hi_Utype_imm",
        "R_RV3264I_got_pcrel_hi_Stype_imm",
        "R_RV3264I_got_pcrel_hi_Btype_imm",
        "R_RV3264I_got_pcrel_hi_Jtype_imm",
        "R_RV3264I_got_pcrel_hi_Ftype_sft"
    );
  }
}
