...
public class EmitImmediateFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        static int64_t RV3264Base_ADDIW_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_ADDI_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_ANDI_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_AUIPC_immUp_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 20), 64, ((uint8_t) 0xc ), 4);
        }
        static int64_t RV3264Base_BEQ_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_BGEU_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_BGE_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_BLTU_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_BLT_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_BNE_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 12), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_JALR_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_JAL_immS_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 20), 64, ((uint8_t) 0x1 ), 1);
        }
        static int64_t RV3264Base_LBU_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LB_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LD_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LHU_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LH_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LUI_immUp_decode(uint64_t param) {
           return VADL_lsl(VADL_sextract(param, 20), 64, ((uint8_t) 0xc ), 4);
        }
        static int64_t RV3264Base_LWU_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_LW_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_ORI_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SB_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SD_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SH_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SLTIU_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SLTI_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_SW_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264Base_XORI_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264I_EBREAK_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static int64_t RV3264I_ECALL_immS_decode(uint64_t param) {
           return VADL_sextract(param, 12);
        }
        static uint8_t RV3264Base_ADDW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_ADD_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_AND_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_OR_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLLIW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLLI_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLLW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLL_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLTU_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SLT_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRAIW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRAI_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRAW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRA_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRLIW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRLI_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRLW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SRL_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SUBW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_SUB_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264Base_XOR_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_DIVUW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_DIVU_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_DIVW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_DIV_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_MULHSU_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_MULHU_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_MULH_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_MULW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_MUL_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_REMUW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_REMU_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_REMW_shamt_decode(uint64_t param) {
           return param;
        }
        static uint8_t RV3264M_REM_shamt_decode(uint64_t param) {
           return param;
        }
