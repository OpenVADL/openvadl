    ...
    Assertions.assertLinesMatch("""
        ...
        bool processornamevalueMCInstExpander::needsExpansion(const MCInst &MCI) const
        {
           ...
           \s
            ...
            case processornamevalue::nonPicLA:
            case processornamevalue::picLA:
        ...
        bool processornamevalueMCInstExpander::expand(const MCInst &MCI, std::vector<MCInst> &MCIExpansion) const
        {
           ...
           \s
              ...
              case processornamevalue::nonPicLA:
              {
                MCIExpansion = RV3264I_nonPicLA_expand(MCI);
                return true;
              }
              case processornamevalue::picLA:
              {
                MCIExpansion = RV3264I_picLA_expand(MCI);
                return true;
              }
              case processornamevalue::LLA:
              {
        ...
        std::vector<MCInst> processorNameValueMCInstExpander::RV3264I_J_expand(const MCInst& instruction) const
        {
              ...
              a.addOperand(MCOperand::createReg(processorNameValue::X0));
              const MCExpr* b = MCOperandToMCExpr(instruction.getOperand(0));
              MCOperand c = MCOperand::createExpr(processorNameValueMCExpr::create(b, processorNameValueMCExpr::VariantKind::VK_DECODE_RV3264I_Jtype_immS, Ctx));
              a.addOperand(c);
              result.push_back(a);
              return result;
        }
        ...
        std::vector<MCInst> processorNameValueMCInstExpander::RV3264I_BEQZ_expand(const MCInst& instruction) const
        {
              ...
              MCOperand c = MCOperand::createExpr(processorNameValueMCExpr::create(b, processorNameValueMCExpr::VariantKind::VK_DECODE_RV3264I_Btype_immS, Ctx));
              a.addOperand(c);
              result.push_back(a);
              return result;
        }
        ...
        std::vector<MCInst> processorNameValueMCInstExpander::registerAdjustment0_expand(const MCInst& instruction) const
        {
              ...
              MCOperand c = MCOperand::createExpr(processorNameValueMCExpr::create(b, processorNameValueMCExpr::VariantKind::VK_SYMB_ABS_RV3264I_Itype_imm, Ctx));
              a.addOperand(c);
              result.push_back(a);
              return result;
        }
