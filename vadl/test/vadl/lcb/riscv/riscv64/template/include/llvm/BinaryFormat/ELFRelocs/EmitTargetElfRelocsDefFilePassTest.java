...
public class EmitTargetElfRelocsDefFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        ELF_RELOC(R_RV3264Base_Btype_ABSOLUTE_immS, 3)
        ELF_RELOC(R_RV3264Base_Btype_RELATIVE_immS, 4)
        ELF_RELOC(R_RV3264Base_Ftype_ABSOLUTE_shamt, 5)
        ELF_RELOC(R_RV3264Base_Ftype_RELATIVE_shamt, 6)
        ELF_RELOC(R_RV3264Base_Itype_ABSOLUTE_immS, 7)
        ELF_RELOC(R_RV3264Base_Itype_RELATIVE_immS, 8)
        ELF_RELOC(R_RV3264Base_Jtype_ABSOLUTE_immS, 9)
        ELF_RELOC(R_RV3264Base_Jtype_RELATIVE_immS, 10)
        ELF_RELOC(R_RV3264Base_Rtype_ABSOLUTE_shamt, 11)
        ELF_RELOC(R_RV3264Base_Rtype_RELATIVE_shamt, 12)
        ELF_RELOC(R_RV3264Base_Stype_ABSOLUTE_immS, 13)
        ELF_RELOC(R_RV3264Base_Stype_RELATIVE_immS, 14)
        ELF_RELOC(R_RV3264Base_Utype_ABSOLUTE_immUp, 15)
        ELF_RELOC(R_RV3264Base_Utype_RELATIVE_immUp, 16)
