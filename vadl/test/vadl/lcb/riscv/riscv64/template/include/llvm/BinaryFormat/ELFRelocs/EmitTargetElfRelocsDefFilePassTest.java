...
public class EmitTargetElfRelocsDefFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Btype_imm, 92)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Ftype_sft, 93)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Itype_imm, 94)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Jtype_imm, 95)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Rtype_rs2, 96)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Stype_imm, 97)
        ELF_RELOC(R_RV3264Base_lowerHalfHi_Utype_imm, 98)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Btype_imm, 99)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Ftype_sft, 100)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Itype_imm, 101)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Jtype_imm, 102)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Rtype_rs2, 103)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Stype_imm, 104)
        ELF_RELOC(R_RV3264Base_lowerHalfLo_Utype_imm, 105)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Btype_imm, 106)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Ftype_sft, 107)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Itype_imm, 108)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Jtype_imm, 109)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Rtype_rs2, 110)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Stype_imm, 111)
        ELF_RELOC(R_RV3264Base_pcrel_hi_Utype_imm, 112)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Btype_imm, 113)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Ftype_sft, 114)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Itype_imm, 115)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Jtype_imm, 116)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Rtype_rs2, 117)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Stype_imm, 118)
        ELF_RELOC(R_RV3264Base_pcrel_lo_Utype_imm, 119)
        ELF_RELOC(R_RV3264Base_to32AndHi_Btype_imm, 120)
        ELF_RELOC(R_RV3264Base_to32AndHi_Ftype_sft, 121)
        ELF_RELOC(R_RV3264Base_to32AndHi_Itype_imm, 122)
        ELF_RELOC(R_RV3264Base_to32AndHi_Jtype_imm, 123)
        ELF_RELOC(R_RV3264Base_to32AndHi_Rtype_rs2, 124)
        ELF_RELOC(R_RV3264Base_to32AndHi_Stype_imm, 125)
        ELF_RELOC(R_RV3264Base_to32AndHi_Utype_imm, 126)
        ELF_RELOC(R_RV3264Base_to32AndLo_Btype_imm, 127)
        ELF_RELOC(R_RV3264Base_to32AndLo_Ftype_sft, 128)
        ELF_RELOC(R_RV3264Base_to32AndLo_Itype_imm, 129)
        ELF_RELOC(R_RV3264Base_to32AndLo_Jtype_imm, 130)
        ELF_RELOC(R_RV3264Base_to32AndLo_Rtype_rs2, 131)
        ELF_RELOC(R_RV3264Base_to32AndLo_Stype_imm, 132)
        ELF_RELOC(R_RV3264Base_to32AndLo_Utype_imm, 133)
        """.trim().lines(), output);
  }
}
