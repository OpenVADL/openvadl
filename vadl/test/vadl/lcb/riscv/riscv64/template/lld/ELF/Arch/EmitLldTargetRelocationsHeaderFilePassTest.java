...
public class EmitLldTargetRelocationsHeaderFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        int64_t RV3264I_got_hi(uint32_t symbol) {
           return VADL_uextract(VADL_lsr(VADL_add(symbol, 32, ((uint32_t) 0x00000800 ), 32), 32, ((uint8_t) 0xc ), 4), 20);
        }
        int64_t RV3264I_Itype_ABSOLUTE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Itype_RELATIVE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Utype_ABSOLUTE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Utype_RELATIVE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Stype_ABSOLUTE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Stype_RELATIVE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Btype_ABSOLUTE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Btype_RELATIVE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Jtype_ABSOLUTE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Jtype_RELATIVE_imm(int64_t input) {
           return input;
        }
        int64_t RV3264I_Rtype_ABSOLUTE_rs2(int64_t input) {
           return input;
        }
        int64_t RV3264I_Rtype_RELATIVE_rs2(int64_t input) {
           return input;
        }
        int64_t RV3264I_Ftype_ABSOLUTE_sft(int64_t input) {
           return input;
        }
        int64_t RV3264I_Ftype_RELATIVE_sft(int64_t input) {
           return input;
        }
        """.trim().lines(), output);
  }
