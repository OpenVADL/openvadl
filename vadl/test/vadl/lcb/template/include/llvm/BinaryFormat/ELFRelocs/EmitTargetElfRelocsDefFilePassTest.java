...
public class EmitTargetElfRelocsDefFilePassTest extends AbstractLcbTest {
  ...
  void testLowering() throws IOException, DuplicatedPassKeyException {
    ...
    Assertions.assertLinesMatch("""
        ...
        ELF_RELOC(R_RV3264I_Utype_ABSOLUTE_imm, 16)
        ELF_RELOC(R_RV3264I_Stype_ABSOLUTE_imm, 17)
        ELF_RELOC(R_RV3264I_Btype_ABSOLUTE_imm, 18)
        ELF_RELOC(R_RV3264I_Jtype_ABSOLUTE_imm, 19)
        ELF_RELOC(R_RV3264I_Ftype_ABSOLUTE_sft, 20)
        ELF_RELOC(R_RV3264I_Itype_RELATIVE_imm, 21)
        ELF_RELOC(R_RV3264I_Utype_RELATIVE_imm, 22)
        ELF_RELOC(R_RV3264I_Stype_RELATIVE_imm, 23)
        ELF_RELOC(R_RV3264I_Btype_RELATIVE_imm, 24)
        ELF_RELOC(R_RV3264I_Jtype_RELATIVE_imm, 25)
