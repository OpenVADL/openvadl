...
class EmitInstrPrinterHeaderFilePassTest {
  ...
  void shouldRenderTemplate() throws IOException {
    ...
    assertThat(output, equalToIgnoringWhiteSpace("""
        #ifndef LLVM_LIB_TARGET_specificationValue _MCTARGETDESC_specificationValue INSTPRINTER_H
        #define LLVM_LIB_TARGET_ specificationValue _MCTARGETDESC_specificationValue INSTPRINTER_H
