...
class Ppc64Test extends AbstractTest {

  private static final Logger log = LoggerFactory.getLogger(Ppc64Test.class);
  ...
  void testGenerateVDT() throws IOException, DuplicatedPassKeyException {
    ...
    var spec = runAndGetViamSpecification("sys/ppc/ppc64.vadl");
    ...
    var insn = Constant.Value.fromInteger(new BigInteger("140a407c", 16), DataType.bits(32));
    DecodedInstruction result = decoder.decode(insn, ByteOrder.LITTLE_ENDIAN);
